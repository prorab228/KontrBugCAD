...
class CADEditor {
    constructor() {
     ...
     //   this.transformControls = null;
      ...
      //  this.sketchTools = null;
        ...
        this._statusTimeout = null; // Для хранения таймера статуса
    ...
    initThemeControls() {
        ...
        const savedTheme = localStorage.getItem('cad-theme') || 'light';
    ...
    initEnvironmentControls() {
        ...
        if (bgColorPicker) {
            ...
            const savedBgColor = localStorage.getItem('cad-bg-color') || '#FFFFFF';
        ...
        if (gridColorPicker && this.gridHelper) {
            ...
            const savedGridColor = localStorage.getItem('cad-grid-color') || '#FFFFFF';
...
//        }
    ...
    setView(view) {
        ...
        console.log('setView',view, this.toolManager.currentTool.name );
        if(view == 'home' && this.toolManager.currentTool.name == 'sketch')
        {
            this.toolManager.getTool('sketch').viewManager.orientCameraToPlane();
        }
        else if (positions[view]) {
    ...
    onKeyDown(e) {
        ...
        console.log('toolManager handleKeyDown', this.toolManager.handleKeyDown(e));
...
//    }
    ...
    showStatus(message, type = 'info', duration = 3000) {
        ...
        // Для критических ошибок можно установить дольше
        const displayTime = type === 'error' ? 5000 : duration;
