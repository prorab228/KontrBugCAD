...
class ExtrudeManager {
    constructor(cadEditor) {
        this.editor = cadEditor;
         this.figureManager = cadEditor.objectsManager.figureManager; // Используем ОДИН FigureManager
    ...
    initialize() {
        ...
        // НЕ создаем новый FigureManager, используем существующий
    ...
    handleFigureClick(event) {
        ...
        try {
            ...
            if (intersects.length > 0) {
                ...
                // Получаем фигуры из FigureManager
